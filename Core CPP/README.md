...
This is the latest **STABLE** engine API, containing all the currently implemented C++ files. Copy from this into your project (don't link to it), and please don't push directly. Instead, push to a branch, then open a merge/pull request.
