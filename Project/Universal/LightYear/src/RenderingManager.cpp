...
int RenderingManager::CreateWindowMenu ()
{
	...
	kiss_array_append (&gui_objects, 0, &window_menu);
	...
	kiss_array_append (&gui_objects, 1, &label_version);
	...
	kiss_array_append (&gui_objects, 2, &label_title);
	...
	kiss_array_append (&gui_objects, 3, &label_subtitle);
	...
	kiss_array_append (&gui_objects, 4, &button_playGame);
	...
	kiss_array_append (&gui_objects, 5, &button_options);
	...
	kiss_array_append (&gui_objects, 6, &button_about);
	...
	kiss_array_append (&gui_objects, 7, &button_quit);
